...
#RUN FILE INI PAKE PYTHON 3
if sys.version[0] in '2':
        exit("\033[1;91m[!] JALANKAN SC INI PAKE PYTHON 3")
...
def virtex2():
	...
	if v=="":
		Aku ("\033[1;91m[!] MOHON ISI DENGAN BENAR!..")
		time.sleep(3)
		virtex2()
	elif v=="99":
		os.system('clear')
		...
		Aku ("\033[1;93m[!] DOWNLOADING FILE!..")
		time.sleep(2)
		os.system('git clone https://github.com/MR-X292/virtex')
		Aku ("\033[1;92m[✓] DOWNLOAD SELESAI!..")
		time.sleep(2)
		input ("\033[1;93m[ KEMBALI ]")
		virtex2()
	elif v=="1" or v=="01":
		Aku ("\033[1;93m[✓] MENDOWNLOAD FILE!..")
		time.sleep(2)
		...
		Aku ("\033[1;93m[✓] MENDOWNLOAD FILE!..")
		time.sleep(2)
		os.system('wget https://raw.githubusercontent.com/Termux-72/Virtex/main/ATTACKER%20ALON.txt')
		Aku ("\033[1;92m[✓] DOWNLOAD SELESAI!..")
		input("\033[1;95m[ KEMBALI ]")
		virtex2()
	elif v =="53":
		Aku ("\033[1;93m[✓] MENDOWNLOAD FILE!..")
		time.sleep(2)
		os.system('wget https://raw.githubusercontent.com/Termux-72/Virtex/main/FrezzN00b.txt')
		Aku ("\033[1;92m[✓] DOWNLOAD SELESAI!..")
		input("\033[1;95m[ KEMBALI ]")
		virtex2()
	elif v =="54":
		Aku ("\033[1;93m[✓] MENDOWNLOAD FILE!..")
		time.sleep(2)
		os.system('wget https://raw.githubusercontent.com/Termux-72/Virtex/main/HekelKokUnicodeByFrezz.txt')
		Aku ("\033[1;92m[✓] DOWNLOAD SELESAI!..")
		input("\033[1;95m[ KEMBALI ]")
		virtex2()
	elif v =="55":
		Aku ("\033[1;93m[✓] MENDOWNLOAD FILE!..")
		time.sleep(2)
		os.system('wget https://raw.githubusercontent.com/Termux-72/Virtex/main/Kode%20Lag%20★ISL★-1-1-1-1.txt')
		Aku ("\033[1;92m[✓] DOWNLOAD SELESAI!..")
		input("\033[1;95m[ KEMBALI ]")
		virtex2()
	elif v =="56":
		Aku ("\033[1;93m[✓] MENDOWNLOAD FILE!..")
		time.sleep(2)
		os.system('wget https://raw.githubusercontent.com/Termux-72/Virtex/main/Nyai•Annah.txt')
		Aku ("\033[1;92m[✓] DOWNLOAD SELESAI!..")
		input("\033[1;95m[ KEMBALI ]")
		virtex2()
	elif v=="57":
		Aku ("\033[1;93m[✓] MENDOWNLOAD FILE!..")
		time.sleep(2)
		os.system('wget https://raw.githubusercontent.com/Termux-72/Virtex/main/SCRIPT~WHATSAPP.txt')
		Aku ("\033[1;92m[✓] DOWNLOAD SELESAI!..")
		input("\033[1;95m[ KEMBALI ]")
		virtex2()
	elif v=="58":
		Aku ("\033[1;93m[✓] MENDOWNLOAD FILE!..")
		time.sleep(2)
		os.system('wget https://raw.githubusercontent.com/Termux-72/Virtex/main/Serigala%20Hitam.txt')
		Aku ("\033[1;92m[✓] DOWNLOAD SELESAI!..")
		input("\033[1;95m[ KEMBALI ]")
		virtex2()
	elif v=="59":
		Aku ("\033[1;93m[✓] MENDOWNLOAD FILE!..")
		time.sleep(2)
		os.system('wget https://raw.githubusercontent.com/Termux-72/Virtex/main/VIR%CF%84%CE%A3XG%CE%94%D0%9F%CE%94%CF%82.txt')
		Aku ("\033[1;92m[✓] DOWNLOAD SELESAI!..")
		input("\033[1;95m[ KEMBALI ]")
		virtex2()
	else:
		Aku ("\033[1;93m[!] KATA KUNCI DARI\033[1;96m "+v+ " \033[1;93mTIDAK DI TEMUKAN!..")
		time.sleep(4)
		virtex2()
...
def bug2():
	...
	if mail=="":
		Aku ("[!] MOHON ISI DENGAN BENAR")
		time.sleep(3)
		bug2()
	elif mail=="1" or mail=="01":
		os.system('clear')
		Aku ("[✓] SILAHKAN HUBUNGI SAYA MELALUI EMAIL DI BAWAH INI!!")
		print ("====================================================")
...
def keluar():
	os.system('clear')
	Aku ("\033[1;93m[?] UDAHAN NIH ?")
	time.sleep(3)
	Aku ("\033[1;92m[✓] MAKASIH YA KAK UDAH PAKE SCRIPTNYA ^_^")
	time.sleep(1)
	exit()
...
def menu():
	...
	print (37*'\033[1;96m=')
	print ('\033[94m[\033[91m1\033[94m] \033[92mDOWNLOAD FILE VIRTEX\n\033[94m[\033[91m2\033[94m] \033[96mPERBARUI KE VERSI BETA\n\033[94m[\033[91m3\033[94m] \033[93mLAPORKAN BUG\n\033[94m[\033[91m0\033[94m] \033[91mKELUAR')
	nu=input("\033[1;93m>>>> \033[1;96m")
	if nu=="":
		Aku ("\033[1;91m[!] ISI YANG BENAR SAYANG KU!..")
		time.sleep(4)
	elif nu=="1" or nu=="01":
		virtex2()
	elif nu=="2" or nu=="02":
		...
		Aku ("\033[1;93m[!] KATA KUNCI DARI\033[1;96m "+nu+ " \033[1;93mTIDAK DI TEMUKAN!..")
		time.sleep(3)
		menu()
...
def BETA():
	...
	try:
		print (nama2)
		print (tabel)
		print ('\033[92mPERBARUI KE VERSI BETA')
		print (25* '\033[96m=')
		a = getpass ('\033[93m[!] TEKAN \033[92mCTRL + C \033[93mUNTUK PERBARUI KE VERSI BETA\n[!] TEKAN \033[92mENTER \033[93mUNTUK MEMBATALKAN PEMBARUAN ')
		if a == "":
			print ('\n\033[95m[!] DI BATALKAN')
			time.sleep(3)
			menu()
		...
		try:
			print ('\n\033[92m[✓] MEMULAI PROSES PEMBARUAN')
			time.sleep(3)
			...
			os.system('wget https://github.com/MR-X-junior/Virtex-Beta/raw/main/README.md')
			os.system('clear')
			...
			print (f'\033[93m[!] UNDUHAN DI MULAI PADA \033[92m{hari}\033[95m:\033[93m{bulan}\033[95m:\033[94m{tahun} \033[96m{jam}\033[95m:\033[93m{menit}\033[95m:\033[97m{detik}')
			time.sleep(2)
			r = requests.get(url)
			...
			try:
				import Virtex_BETA
				print (f'\033[92m[✓] DOWNLOAD SELESAI PADA \033[92m{hari2}\033[95m:\033[93m{bulan2}\033[95m:\033[94m{tahun2} \033[96m{jam2}\033[95m:\033[93m{menit2}\033[95m:\033[97m{detik2}')
				time.sleep(2)
				print ('\033[92m[✓] MENGINSTAL BAHAN ^_^')
				time.sleep(2)
				os.system('python bahan.py')
				os.system('rm Virtex.py')
				exit()
			except ModuleNotFoundError:
